...
int main() {
    Ticket ticket1("VIP", "07", "10:00", "Maria Elena", "07-01-2022", "Casa Poporului");
    cout << "Ticket 1:\n";
    ...
    cout << "\nTicket 3 ID: " << int(ticket3) << endl;

    if (!ticket1) {
        cout << "\nTicket 1 is empty." << endl;
    }
    else {
        cout << "\nTicket 1 is not empty." << endl;
    }

    if (ticket1 == ticket2) {
        cout << "\nTicket 1 is equal to Ticket 2." << endl;
    }
    else {
        cout << "\nTicket 1 is not equal to Ticket 2." << endl;
    }
